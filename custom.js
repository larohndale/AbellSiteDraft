// custom javascript until Python course to actually work with back end data
...
if (confirm("Do you understand this data will not be submitted until future updates") == true) {
    txt = "You pressed OK!";
} else {
